    ...
    <div class="fixed top-4 right-4 z-[100] flex flex-col gap-2 max-w-sm w-full pointer-events-none">
      ...
      >
        <div
          ...
          :key="toast.id"
          :class="[colors[toast.type], 'pointer-events-auto flex items-start gap-3 px-4 py-3 rounded-lg border shadow-lg']"
        >
          <span class="flex-shrink-0 mt-0.5" v-html="icons[toast.type]"></span>
